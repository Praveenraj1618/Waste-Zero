...
export function AdminDashboardPage({ onNavigate }: AdminDashboardPageProps) {
  const activityLog = [
    { id: 1, action: 'User registration', user: 'John Doe', timestamp: '2 minutes ago', type: 'user' },
    { id: 2, action: 'New opportunity posted', user: 'Green Earth NGO', timestamp: '15 minutes ago', type: 'opportunity' },
    { id: 3, action: 'Pickup completed', user: 'Sarah Johnson', timestamp: '1 hour ago', type: 'pickup' },
    { id: 4, action: 'NGO registered', user: 'EcoWarriors', timestamp: '2 hours ago', type: 'ngo' },
    { id: 5, action: 'Report generated', user: 'Admin', timestamp: '3 hours ago', type: 'report' },
    { id: 6, action: 'User joined opportunity', user: 'Mike Chen', timestamp: '4 hours ago', type: 'opportunity' },
    { id: 7, action: 'Pickup scheduled', user: 'Emily Davis', timestamp: '5 hours ago', type: 'pickup' },
    { id: 8, action: 'User updated profile', user: 'Alex Brown', timestamp: '6 hours ago', type: 'user' },
  ];
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl mt-1">5,678</p>
