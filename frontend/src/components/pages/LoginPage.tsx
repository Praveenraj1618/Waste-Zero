    ...
    <div className="min-h-screen grid md:grid-cols-2">
      ...
      <div className="hidden md:block relative bg-gradient-to-br from-primary to-secondary">
        <div className="absolute inset-0">
          <ImageWithFallback 
            src="https://images.unsplash.com/photo-1637681262973-a516e647e826?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZWN5Y2xpbmclMjB3YXN0ZSUyMG1hbmFnZW1lbnR8ZW58MXx8fHwxNzYwMzczNDY0fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
        ...
        <div className="relative z-10 h-full flex items-center justify-center p-12">
          <div className="text-white text-center max-w-lg">
            ...
            <p className="text-lg text-white/90">
              ...
              Every login brings us closer to a sustainable future.
            </p>
